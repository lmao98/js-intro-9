...
// Using the formela to find the average of two numbers is given by adding a group of numbers and then dividing by the count of those numbers.
...
console.log(`The area of the square = ${side ** 2}`); // or side * side
